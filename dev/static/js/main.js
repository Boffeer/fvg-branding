  ...
  $("a").click(function () {
    ...
    $('.js-footer-slider').slick({
      ...
      slidesToScroll: 1,
    	...
    	arrows: false,
      swipeToSlide: true,
      nextArrow: '<svg class="slick-next" width="89" height="120" viewBox="0 0 89 120" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M37.6531 105.048L68.7658 63.0986C70.035 61.3873 70.035 58.6127 68.7658 56.9014L37.6531 14.9517C36.5792 13.5038 36.5792 11.156 37.6531 9.70803L42.5552 3.09856C43.6291 1.65056 45.3703 1.65056 46.4442 3.09856L86.7016 57.3782C87.7755 58.8262 87.7755 61.1738 86.7016 62.6218L46.4442 116.901C45.3703 118.349 43.6291 118.349 42.5552 116.901L37.6531 110.292C36.5792 108.844 36.5792 106.496 37.6531 105.048Z" fill="white" stroke="#232323"/></svg>',
      prevArrow: '<svg class="slick-prev" width="89" height="120" viewBox="0 0 89 120" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M51.3461 14.9517L20.2334 56.9014C18.9642 58.6127 18.9642 61.3873 20.2334 63.0986L51.3461 105.048C52.42 106.496 52.42 108.844 51.3461 110.292L46.444 116.901C45.3701 118.349 43.6289 118.349 42.555 116.901L2.29764 62.6218C1.2237 61.1738 1.2237 58.8262 2.29764 57.3782L42.555 3.09856C43.6289 1.65056 45.3701 1.65056 46.444 3.09856L51.3461 9.70803C52.42 11.156 52.42 13.5038 51.3461 14.9517Z" fill="white" stroke="#232323"/></svg>',
